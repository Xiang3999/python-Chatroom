...
# 变量初始化
# 服务端下载的文件的的存放路径
filePath = "D:\\onedrive-pao\\OneDrive - std.uestc.edu.cn\\note\\Python\\CS\\ftp\\client\\"
codepath = "D:\\onedrive-pao\\OneDrive - std.uestc.edu.cn\\note\\Python\\CS\\ftp\\client\\test.txt"
BUFFSIZE = 51200
# 加密解密函数
CODESIZE = 64
CODE = "utf-8"
